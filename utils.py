...
def get_classification_model(model_name):
    if model_name == "upperbody":
        ...
        return "upperbody"#tf.keras.models.load_model(os.path.join(main_directory, 'modeller/upperbody/upperbody_acc_train_092_val_073_incV3_299_299.h5'))#(os.path.join(main_directory, 'modeller/upperbody/upperbody_acc_train_092_val_073_incV3_299_299.h5'))
    if model_name == "lowerbody":
        ...
        #local_path = tf.keras.utils.get_file("my-model.h5", model_url)
        return "tensorflow-inference-2023-02-02-11-56-13-035"#tf.keras.models.load_model(os.path.join(main_directory, 'modeller/lowerbody/lowerbody_acc_train_095_val_087_incV3_299_299_v2.h5'))#(os.path.join(main_directory, 'modeller/lowerbody/lowerbody_acc_train_095_val_087_incV3_299_299_v2.h5'))
    if model_name == "pants":
        #model_url = "https://fashionanalysis.s3.amazonaws.com/Modeller/pants_type_acc_train_09_val_08_incV3_299_299.h5"
        #local_path = tf.keras.utils.get_file("my-model.h5", model_url)
        return "pants"#tf.keras.models.load_model(os.path.join(main_directory, 'modeller/lowerbody/pants/pants_type_acc_train_09_val_08_incV3_299_299.h5'))#(os.path.join(main_directory, 'modeller/lowerbody/pants/pants_type_acc_train_09_val_08_incV3_299_299.h5'))
    if model_name == "accessories":
        ...
        #local_path = tf.keras.utils.get_file("my-model.h5", model_url)
        return "accessories"#tf.keras.models.load_model(os.path.join(main_directory, 'modeller/accessories/accessories_acc_train_098_val_093_incV3_299_299_v2.h5'))#(os.path.join(main_directory, 'modeller/accessories/accessories_acc_train_098_val_093_incV3_299_299_v2.h5'))
    if model_name == "shirt_blouse":
        ...
        #local_path = tf.keras.utils.get_file("my-model.h5", model_url)
        return "gomlekkol"#tf.keras.models.load_model(os.path.join(main_directory, 'modeller/upperbody/gomlek_kol/gomlek_kol_uzunluk_acc_train_099_val_089_incV3_299_299.h5'))#(os.path.join(main_directory, 'modeller/upperbody/gomlek_kol/gomlek_kol_uzunluk_acc_train_099_val_089_incV3_299_299.h5'))
    if model_name == "sweater":
        ...
        #local_path = tf.keras.utils.get_file("my-model.h5", model_url)
        return "shirtneck"#tf.keras.models.load_model(os.path.join(main_directory, 'modeller/upperbody/kazak_yaka/shirt_neck_acc_train_093_val_083_incV3_299_299_v3.h5'))#(os.path.join(main_directory, 'modeller/upperbody/kazak_yaka/shirt_neck_acc_train_093_val_083_incV3_299_299_v3.h5'))
    if model_name == "skirt_length":
        #model_url = "https://fashionanalysis.s3.amazonaws.com/Modeller/skirt_length_incV3_299_299.h5"
        #local_path = tf.keras.utils.get_file("my-model.h5", model_url)
        return "skirtlength2"#tf.keras.models.load_model(os.path.join(main_directory, 'modeller/lowerbody/skirt_length/skirt_length_incV3_299_299.h5'))#(os.path.join(main_directory, 'modeller/lowerbody/skirt_length/skirt_length_incV3_299_299.h5'))   
    if model_name == "skirt_opening":
        ...
        #local_path = tf.keras.utils.get_file("my-model.h5", model_url)
        return "skirtopening2"#tf.keras.models.load_model(os.path.join(main_directory, 'modeller/lowerbody/skirt_opening/skirt_opening_acc_train_099_val_093_incV3_299_299.h5'))#(os.path.join(main_directory, 'modeller/lowerbody/skirt_opening/skirt_opening_acc_train_099_val_093_incV3_299_299.h5'))   
...
def predict_class_name(image,class_name):
    ...
    ENDPOINT_NAME = get_classification_model(class_name)
    ...
    prediction_scores = json.loads(response['Body'].read().decode())
